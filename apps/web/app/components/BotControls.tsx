...
type SupportedSymbol = 'BTCUSDT' | 'ETHUSDT' | 'ADAUSDT' | 'ZECUSDT' | 'UNIUSDT' | 'RUNEUSDT';
...
export default function BotControls() {
  ...
  useEffect(() => {
    const handleSymbolChange = (event: Event) => {
      ...
      if (next === 'BTCUSDT' || next === 'ETHUSDT' || next === 'ADAUSDT' || next === 'ZECUSDT' || next === 'UNIUSDT' || next === 'RUNEUSDT') setSymbol(next);
    };
